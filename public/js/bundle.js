...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieW9nZXNobWlzaHJhNjY3IiwiYSI6ImNrZWppMnRhbjB1ZTAzMHBjempnbjE3dmcifQ.aAvAKk9uR3UBEAs8v9ulxA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/yogeshmishra667/ckeju6wlk3bls19ocl73z63tp' // center: [78.8718, 21.7679],
    // zoom: 3.7,
    // interactive: false
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('error', "Logged out successfully. Bye-Bye see you again");
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'something went wrong'); //console.log(err.response);
...
var stripe = Stripe('pk_test_9DVLGrEmCkv5M98RFzeRWDQp00Ds27EpKA');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)( //TOUR ID COMES FROM TOUR.PUG & INDEX.JS VIA DATASET
            "http://127.0.0.1:3000/api/v1/booking/checkout-session/".concat(tourId));
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"thumbnail.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handleFileSelect = void 0;
...
var handleFileSelect = function handleFileSelect(evt) {
  ...
  reader.onload = function (theFile) {
    ...
    return function (e) {
      document.getElementById('list').innerHTML = ["<img src= ".concat(e.target.result, " title= ").concat(theFile.name, " />")]; //.join('');
    };
  }(f);
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.showAlert)('success', "user registered successfully welcome ".concat(userName, "!"));
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var formData = document.querySelector('.form--login');
var userUpdateBtn = document.querySelector('.form-user-data');
var passwordUpdateForm = document.querySelector('.form-user-password');
var userLogoutBtn = document.querySelector('.nav__el--logout');
var thumbnail = document.getElementById('photo');
var bookBtn = document.getElementById('book-tour');
var signupFormData = document.querySelector('.form--signup'); // DELEGATION

if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations);
  (0, _mapbox.displayMap)(locations); // what will put data in data-locations (locations) is field and you can access locations data using dataset
...
if (userLogoutBtn) {
  userLogoutBtn.addEventListener('click', _login.logout);
} //FOR USER DATA UPDATE


if (userUpdateBtn) {
  userUpdateBtn.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); //FOR CHANGE BTN TEXT
